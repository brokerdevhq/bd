(ns ca.brokerdev.core.build.interface
...
(defn uberjar
  ...
  [{:keys [version project uber-file] :as opts}]
  (println "Building with opts: " opts)
  (let [project-root (ensure-project-root "uberjar" project)
    ...
    (b/with-project-root project-root
      (let [class-dir "target/classes"
            version   version
            version-file (str project-root "/" class-dir "/version.txt")
